...
The proof, both directions from HILNO's ingredients, follows Lemma 9. **Not new:** Theorem 2 is [HILNO Theorem 1, (1)⇔(3)] packaged in expectation form, (1) ⇒ (2) as stated and HILNO's Lemma 20 argument for the converse; its value is the sentence it licenses, *one-way functions exist if and only if some efficiently samplable process dissipates.*
...
- Li, M., Vitányi, P. *An Introduction to Kolmogorov Complexity and Its Applications*, 2nd ed. [via Grünwald–Vitányi 2004]
...
- Marletto, C., Vedral, V. (2017). Phys. Rev. Lett. 119:240402 (title not carried; details from Fox, Karamchedu and Mygdalas 2026, reference 9). [via Fox–Karamchedu–Mygdalas 2026]
...
- Zurek, W. H. (1989). Nature 341:119. [via Bennett, Gács, Li, Vitányi and Zurek 1998 §VIII]
