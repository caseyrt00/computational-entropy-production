...
**Corrections (24 September 2026; updated 26 September 2026).** The PDF here is v2.4: the paper of 20 September with a one-page *Corrections and attributions* section at the front, listing everything below; no other change. It is Zenodo version 2, DOI [10.5281/zenodo.22981114](https://doi.org/10.5281/zenodo.22981114); version 1 (20 September) stays at 10.5281/zenodo.22947444. The revised, shorter version is published: *Unbounded exponential moments of time-bounded information asymmetry without one-way functions, relative to an oracle*, Zenodo, DOI [10.5281/zenodo.22980359](https://doi.org/10.5281/zenodo.22980359) (13 pp.). It strengthens Proposition 10 (probability 1 over the oracle; absence of one-way functions proved directly) and supersedes this paper for the results stated there. The current version (v2.3, the PDF here and on Zenodo) does not cite the literature on computational entropy. The mean of σ is, up to O(log n) and a change of time bound, the *KL-hardness for sampling* of Vadhan and Zheng (STOC 2012; ECCC TR11-141) — the *relative pseudoentropy* of Agrawal, Chen, Horel and Vadhan (CRYPTO 2019; arXiv 1902.11202); see also Haitner, Reingold, Vadhan and Wee (inaccessible entropy; arXiv 2010.05586) and Haitner and Vadhan (ECCC TR17-084). The identification itself rests on the equivalence between pK^t and the time-bounded universal distribution recorded by Hirahara and Nanashima (FOCS 2023; ECCC TR23-100, Appendix B), one half of which is the coding theorem of Lu, Oliveira and Zimand (ICALP 2022) with an auxiliary input; this paper did not cite the former (added 26 September 2026). The reading of dissipation as hardness of reverse sampling is theirs, not this paper's. Theorem 1 is assembled from Lu–Oliveira–Zimand 2022 and HILNO 2023 (Lemmas 8–9); Theorem 4's mechanism is HILNO 2023, Appendix A (Theorem 55, Claim 57). What remains new is Proposition 10 and the bounded-exponential-moments sandwich.
